                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <c:if test="${page.topicList!=null}">
                        <c:forEach items="${page.topicList}" var="Que">
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="<%=path%>/ShowUpdInfoByCourse?subject_id=${Que.subject.subject_id}&QueId=${Que.q_id}&pageNo=${page.currentPageNO}">更新</a>&nbsp;&nbsp;
                                      <%--  <a href="<%=path%>/DelQuestion?subject_id=${Que.subject.subject_id}&QueId=${Que.q_id}&pageNo=${page.currentPageNO}">删除</a>--%>
                                    </center>
                                </td>
                            </tr>
                        </c:forEach>
                    ...
                    <tr>
                        <td colspan="11" align="center">
                            ...
                            <a href="SelQuestion?subject_id=${subject_id}&pageNo=1">首页</a> |
                            <a href="SelQuestion?subject_id=${subject_id}&pageNo=${page.currentPageNO - 1}">上一页</a> |

                            <a href="SelQuestion?subject_id=${subject_id}&pageNo=${page.currentPageNO + 1}">下一页</a> |
                            <a href="SelQuestion?subject_id=${subject_id}&pageNo=${page.totalPageCount}">尾页</a>
