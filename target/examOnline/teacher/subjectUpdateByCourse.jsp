            ...
            <div class="maincontentinner">
                <div class="widget">
                    ...
                    <div class="widgetcontent">
                        <form class="stdform" action="QuestionByCourseUpdate" method="post">
                            <p>
                                <label>学科</label>
                                <span class="field">
                                    <select name="subject_id">
                                        <c:forEach items="${requestScope.SubList}" var="ShowSub">
                                            <option value="${ShowSub.subject_id}"
                                                    <c:if test="${ShowSub.subject_id==requestScope.question.subject.subject_id}">selected='selected'</c:if>>${ShowSub.subject_name}</option>
                                        </c:forEach>
                                    </select>
						 </span>
