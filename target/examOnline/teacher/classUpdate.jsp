    ...
    <div class="rightpanel">
        ...
        <div class="maincontent" style="">
            <div class="maincontentinner">
                ...
                <div class="widget">
                    <h4 class="widgettitle">班级编辑</h4>
                    <div class="widgetcontent">
                        <form class="stdform" action="TClassUpdate" method="post">
                            <input name="c_id" type="hidden" value="${tClass.c_id}"/>
                            <input name="pageNo" type="hidden" value="${pageNo}"/>
                            <p>
                                <label>班级名称:</label>
                                <span class="field"><input type="text" name="c_name" class="input-large"
                                                           placeholder="班级名称" value="${tClass.c_name}"/></span>
                            </p>
