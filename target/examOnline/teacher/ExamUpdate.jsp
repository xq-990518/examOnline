            ...
            <div class="maincontentinner">
                <div class="widget">
                    ...
                    <div class="widgetcontent">
                        <form class="stdform" action="ExamUpdate" method="post">

                            <p>
                                <label>试卷名称</label>
                                <span class="field">
						        <input name="e_name" type="text" class="input-large"
                                       placeholder="时长" value="${exam.e_name}"/>
						 </span>
                            </p>
                            <p>
                                <label>考试时间:</label>
                                <span class="field"><input type="text" name="date" class="input-large"
                                                           placeholder="时长"
                                                           value="${exam.e_examDate}"></span>
                            </p>
