                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <c:forEach items="${page.topicList}" var="list">
                        <tr align="center">
                            ...
                            <td>
                                <center>
                                    <a href="<%=path%>/teacher/ShowStuInfo?ByAll='ByAll'&StuId=${list.s_id}&pageNo=${page.currentPageNO}">更新</a>&nbsp;&nbsp;
                                    <a href="<%=path%>/teacher/DelStudentByAll?ByAll='ByAll'&StuId=${list.s_id}&pageNo=${page.currentPageNO}">删除</a>
                                </center>
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            ...
                            <a href="<%=path%>/teacher/SelAllStu?pageNo=1">首页</a> |
                            <a href="<%=path%>/teacher/SelAllStu?pageNo=${page.currentPageNO - 1}">上一页</a> |

                            <a href="<%=path%>/teacher/SelAllStu?pageNo=${page.currentPageNO + 1}">下一页</a> |
                            <a href="<%=path%>/teacher/SelAllStu?pageNo=${page.totalPageCount}">尾页</a>
