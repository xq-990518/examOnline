...
public class ShowMarkByExamController implements Controller {
    @Autowired
    private ExamBiz examBiz;
    @Autowired
    private TeacherMapper teacherMapper;

    @RequestMapping(value = "/ShowMarkByExam")
    @Override
    public ModelAndView handleRequest(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        modelAndView = new ModelAndView("teachers/showExamScore", map);
        return modelAndView;
    }
}
