...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <a href="<%=path %>/teachers/ShowMarkOrderCon?c_id=${c_id}&e_id=${e_id}&pageNo=0">
            ...
            <div class="maincontentinner">
                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <tr>
                        ...
                        <th class="head0">所属班级</th>
                        <th class="head1">试卷名称</th>
                        <th class="head0">考试分数</th>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr align="center">
                            ...
                            <td>
                                ...
                                <c:if test="${list.tClass.c_id==c_id}">
                                    <c:if test="${not empty list.achievements}">
                                        <%--通过学生表查询到的成绩不为空时,接着通过e_id查询到的Ach为空时则显示未考试--%>
                                        <c:if test="${empty ShowMarkByExam}">
                                            未考试
                                        </c:if>
                                    ...
                                    <%--通过学生查询到的Ach为空时则显示未考试--%>
                                    <c:if test="${empty list.achievements}">
                                        未考试
                                    </c:if>
                                </c:if>
                            </td>
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            ...
                            <a href="ShowMarkByExam?c_id=${c_id}&e_id=${e_id}&pageNo=1">首页</a>
                            |
                            <a href="ShowMarkByExam?c_id=${c_id}&e_id=${e_id}&pageNo=${page.currentPageNO - 1}">上一页</a>
                            |
                            <a href="ShowMarkByExam?c_id=${c_id}&e_id=${e_id}&pageNo=${page.currentPageNO + 1}">下一页</a>
                            |
                            <a href="ShowMarkByExam?c_id=${c_id}&e_id=${e_id}&pageNo=${page.totalPageCount}">尾页</a>
