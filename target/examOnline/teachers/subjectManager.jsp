        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <table id="dyntable" class="table table-bordered responsive">
                        ...
                        <c:forEach items="${page.topicList}" var="Que">
                            <tr>
                                ...
                                <td>
                                    <center>
                                            <%--   teacher前不能加--%>
                                        <a href="QuestionBeforeUpdate?QueId=${Que.q_id}&pageNo=${page.currentPageNO}">更新</a>&nbsp;&nbsp;
                                       <%-- <a href="QuestionDelete?s_id=${teacher.subject.subject_id}&QueId=${Que.q_id}&pageNo=${page.currentPageNO}">删除</a>--%>
                                    </center>
                                </td>
                            </tr>
                        </c:forEach>
                    ...
                    <tr>
                        <td colspan="11" align="center" width="100%">
                            共${page.totalCount}条纪录，当前第${page.currentPageNO}/${page.totalPageCount}页，每页${page.pageSize}条纪录

                            <a href="QueryQuestion?s_id=${teacher.subject.subject_id}&pageNo=1">首页</a> |
                            <a href="QueryQuestion?s_id=${teacher.subject.subject_id}&pageNo=${page.currentPageNO - 1}">上一页</a> |

                            <a href="QueryQuestion?s_id=${teacher.subject.subject_id}&pageNo=${page.currentPageNO + 1}">下一页</a> |
                            <a href="QueryQuestion?s_id=${teacher.subject.subject_id}&pageNo=${page.totalPageCount}">尾页</a>
