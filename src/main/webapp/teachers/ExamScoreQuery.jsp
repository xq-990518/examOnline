...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajax() {
            $.ajax({
                url: "http://localhost:8080/examOnline_war/ExamShowSelect",
                type: "post",
                data: {"s_id": "${teacher.subject.subject_id}"},
                dataType: "json",
                success: function (result) {
                    for (var i = 0; i < result[0]["MapStr"].length; i++) {
                        $("#showExam").append(
                            "<option value=" + result[0]["MapStr"][i].e_id + ">" + result[0]["MapStr"][i].e_name + "</option>"
                        );
                    }
                },
                error: function () {
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent" style="">
            <div class="maincontentinner">
                ...
                <div class="widget">
                    <h4 class="widgettitle">根据试卷名查询成绩</h4>
                    <div class="widgetcontent">
                        <form class="stdform" action="ShowMarkByExam?pageNo=0" method="post">
                            <label>试卷名:</label>
                            <span class="field">
	                          	<select name="e_id" id="showExam" class="form-control">
                            ...
                            %>
                                <input type="hidden" name="c_id" value="<%=c_id%>"/><%--班级id--%>
                            </p>
