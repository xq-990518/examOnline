...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <a href="<%=path %>/teacher/studentQueryByClass.jsp">
                <button>根据班级查找学生</button>
            </a>
            <a href="<%=path %>/teacher/studentQueryByName.jsp">
                <button>根据姓名查找学生</button>
            </a>
            <a href="<%=path %>/teacher/studentQueryByID.jsp">
                <button>根据学号查找学生</button>
            </a>
        </div>
                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <c:forEach items="${page.topicList}" var="list">
                        <tr align="center">
                            ...
                            <td>
                                <center>
                                    <a href="<%=path%>/teacher/ShowStuInfoByClass?sclass=${list.tClass.c_id}&ByClass='ByClass'&StuId=${list.s_id}&pageNo=${page.currentPageNO}">更新</a>&nbsp;&nbsp;
                                    <a href="<%=path%>/teacher/DelStudentByClass?sclass=${list.tClass.c_id}&ByClass='ByClass'&StuId=${list.s_id}&pageNo=${page.currentPageNO}">删除</a>
                                </center>
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            ...
                            <a href="<%=path%>/teacher/ByClassCon?ByClass='ByClass'&sclass=${c_id}&pageNo=1">首页</a> |
                            <a href="<%=path%>/teacher/ByClassCon?ByClass='ByClass'&sclass=${c_id}&pageNo=${page.currentPageNO - 1}">上一页</a>
                            |

                            <a href="<%=path%>/teacher/ByClassCon?ByClass='ByClass'&sclass=${c_id}&pageNo=${page.currentPageNO + 1}">下一页</a>
                            |
                            <a href="<%=path%>/teacher/ByClassCon?ByClass='ByClass'&sclass=${c_id}&pageNo=${page.totalPageCount}">尾页</a>
