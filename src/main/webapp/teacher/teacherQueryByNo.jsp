    ...
    <div class="rightpanel">
        ...
        <div class="maincontent" style="">
            <div class="maincontentinner">
                ...
                <div class="widget">
                    <h4 class="widgettitle">根据工号查询教师</h4>
                    <div class="widgetcontent">
                        <form class="stdform" action="getTeacherByNo?pageNo=0" method="post">

                            <label>教师工号:</label>
                            <span class="field"><input type="text" name="t_No"  class="input-xlarge" placeholder="请输入..." /></span>
