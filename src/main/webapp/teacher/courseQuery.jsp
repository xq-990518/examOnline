        ...
        <div class="maincontent">
            <div class="maincontentinner">
                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <tr align="center">
                        <th class="head0" width="34%">科目编号</th>
                        <th class="head1" width="33%">科目名称</th>
                        <th class="head0" width="33%">操作</th>
                    </tr>

                    </thead>
                    <tbody>
                    <c:forEach var="subject" items="${page.topicList}">
                        <tr align="center">
                            <td>
                                    ${subject.subject_id}
                            </td>
                            ...
                            <td>
                                <a href="SubjectBeforeUpdate?subject_id=${subject.subject_id}&pageNo=${page.currentPageNO}">更新</a>
                                <a href="SubjectDelete?subject_id=${subject.subject_id}&pageNo=${page.currentPageNO}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            ...
                            <a href="SubjectQuery?pageNo=1">首页</a> |
                            <a href="SubjectQuery?pageNo=${page.currentPageNO - 1}">上一页</a> |

                            <a href="SubjectQuery?pageNo=${page.currentPageNO + 1}">下一页</a> |
                            <a href="SubjectQuery?pageNo=${page.totalPageCount}">尾页</a>
