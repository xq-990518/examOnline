    ...
    <div class="rightpanel">
        ...
        <div class="maincontent" style="">
            <div class="maincontentinner">
                ...
                <div class="widget">
                    <h4 class="widgettitle">科目编辑</h4>
                    <div class="widgetcontent">
                        <form class="stdform" action="SubjectUpdate" method="post">
                            <input name="subject_id" type="hidden" value="${subject.subject_id}"/>
                            <input name="pageNo" type="hidden" value="${pageNo}"/>
                            <p>
                                <label>科目名称:</label>
                                <span class="field"><input type="text" name="subject_name" class="input-large"
                                                           placeholder="科目名称" value="${subject.subject_name}"/></span>
                            </p>
